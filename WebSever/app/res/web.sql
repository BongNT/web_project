...
--
CREATE
DATABASE IF NOT EXISTS `web` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE
`web`;
...
INSERT INTO `coso` (`id_coso`, `ten`, `loaihinh`, `id_huyen`, `sdt`)
VALUES (8, 'test', 1, '002HH', '0132'),
...
INSERT INTO `giaychungnhan` (`id_giay`, `ngaycap`, `ngayhethan`, `status`, `id_coso`)
VALUES (1, '2022-05-28', '2022-05-29', 2, 8),
...
INSERT INTO `huyen` (`id_huyen`, `tenhuyen`, `id_thanhpho`)
VALUES ('001HH', 'Quận Ba Đình', '01TTT'),
